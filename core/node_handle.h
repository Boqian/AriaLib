...
public:
  ...
  template <class Self> value_type &value(this Self const &self) { return self.get()->get_value(); }
};
...
public:
  ...
  template <class Self> key_type &key(this Self const &self) { return self.get()->get_value().first; }
  template <class Self> mapped_type &mapped(this Self const &self) { return self.get()->get_value().second; }
};
